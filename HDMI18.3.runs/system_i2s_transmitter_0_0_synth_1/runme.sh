...
HD_PWD='E:/141/HDMI18.3/HDMI18.3.runs/system_i2s_transmitter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_i2s_transmitter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_i2s_transmitter_0_0.tcl
