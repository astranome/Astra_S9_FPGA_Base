...
HD_PWD='E:/141/HDMI18.3/HDMI18.3.runs/system_axi_uartlite_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_uartlite_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_uartlite_0_2.tcl
