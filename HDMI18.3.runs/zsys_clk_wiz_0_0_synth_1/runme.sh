...
HD_PWD='E:/HDMI18.3/HDMI18.3.runs/zsys_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zsys_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zsys_clk_wiz_0_0.tcl
