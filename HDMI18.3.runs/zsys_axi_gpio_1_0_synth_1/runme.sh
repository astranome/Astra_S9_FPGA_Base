...
HD_PWD='E:/HDMI18.3/HDMI18.3.runs/zsys_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zsys_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zsys_axi_gpio_1_0.tcl
