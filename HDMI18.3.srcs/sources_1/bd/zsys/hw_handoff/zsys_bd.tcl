...
proc create_hier_cell_video_out { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_OUT1_PORT {clk_74MHz} \
   CONFIG.CLK_OUT2_PORT {clk_371MHz} \
  ...
  connect_bd_net -net Net [get_bd_pins axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axis_fb_conv_0/s_axis_aclk] [get_bd_pins clk_wiz_1/s_axi_aclk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tc_0/s_axi_aclk]
  ...
  connect_bd_net -net clk_wiz_1_clk_371MHz [get_bd_pins Video_IO_2_HDMI_TMDS_0/video_clk5x_in] [get_bd_pins clk_wiz_1/clk_371MHz]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins Video_IO_2_HDMI_TMDS_0/lock_in] [get_bd_pins clk_wiz_1/locked]
  connect_bd_net -net ref_clk_1 [get_bd_pins ref_clk] [get_bd_pins clk_wiz_1/clk_in1]
  connect_bd_net -net v_axi4s_vid_out_0_vtg_ce [get_bd_pins v_axi4s_vid_out_0/vtg_ce] [get_bd_pins v_tc_0/gen_clken]
  connect_bd_net -net video_clk_in_1 [get_bd_pins Video_IO_2_HDMI_TMDS_0/video_clk_in] [get_bd_pins clk_wiz_1/clk_74MHz] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_tc_0/clk]
...
proc create_root_design { parentCell } {
  ...
  set SPI0_SS1_O_0 [ create_bd_port -dir O SPI0_SS1_O_0 ]
  set SPI0_SS_O_0 [ create_bd_port -dir O SPI0_SS_O_0 ]
  set Vp_Vn_v_n_0 [ create_bd_port -dir I Vp_Vn_v_n_0 ]
  set Vp_Vn_v_p_0 [ create_bd_port -dir I Vp_Vn_v_p_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_ENET0_PERIPHERAL_FREQMHZ {24.999996} \
   CONFIG.PCW_ACT_ENET1_PERIPHERAL_FREQMHZ {10.000000} \
   CONFIG.PCW_ACT_FPGA0_PERIPHERAL_FREQMHZ {99.999985} \
   ...
   CONFIG.PCW_ACT_SMC_PERIPHERAL_FREQMHZ {99.999985} \
   CONFIG.PCW_ACT_SPI_PERIPHERAL_FREQMHZ {166.666641} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports gpio_rtl_1] [get_bd_intf_pins axi_gpio_LED/GPIO]
  ...
  connect_bd_net -net Vp_Vn_v_n_0_1 [get_bd_ports Vp_Vn_v_n_0] [get_bd_pins audio/Vp_Vn_v_n]
  connect_bd_net -net Vp_Vn_v_p_0_1 [get_bd_ports Vp_Vn_v_p_0] [get_bd_pins audio/Vp_Vn_v_p]
  ...
  connect_bd_net -net clk_wiz_0_clk_12MHz [get_bd_pins audio/audio_clk] [get_bd_pins clk_wiz_0/clk_12MHz]
  connect_bd_net -net clk_wiz_0_clk_200MHz [get_bd_pins clk_wiz_0/clk_200MHz] [get_bd_pins video_out/ref_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins audio/axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_LED/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_100MHz] [get_bd_pins processing_system7_0/DMA0_ACLK] [get_bd_pins processing_system7_0/DMA1_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/M04_ACLK] [get_bd_pins processing_system7_0_axi_periph/M05_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins resets/axi_clk] [get_bd_pins video_out/axi_aclk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins resets/ext_reset_in]
  ...
  connect_bd_net -net processing_system7_0_SPI0_SS1_O [get_bd_ports SPI0_SS1_O_0] [get_bd_pins processing_system7_0/SPI0_SS1_O]
  connect_bd_net -net processing_system7_0_SPI0_SS_O [get_bd_ports SPI0_SS_O_0] [get_bd_pins processing_system7_0/SPI0_SS_O]
  connect_bd_net -net rst_processing_system7_0_50M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins resets/axi_int_aresetn] [get_bd_pins video_out/axi_int_aresetn]
  connect_bd_net -net rst_processing_system7_0_50M_peripheral_aresetn [get_bd_pins audio/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_LED/s_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M05_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins resets/axi_per_aresetn] [get_bd_pins video_out/axi_per_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_LED/S_AXI/Reg] SEG_axi_gpio_1_Reg
