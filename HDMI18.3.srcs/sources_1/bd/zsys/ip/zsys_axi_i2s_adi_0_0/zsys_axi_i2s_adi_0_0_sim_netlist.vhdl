...
-- Date        : Mon Feb 10 00:25:41 2025
-- Host        : DESKTOP-0SNREP6 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               E:/HDMI18.3/HDMI18.3.srcs/sources_1/bd/zsys/ip/zsys_axi_i2s_adi_0_0/zsys_axi_i2s_adi_0_0_sim_netlist.vhdl
...
entity zsys_axi_i2s_adi_0_0_dma_fifo is
  port (
    ...
    \free_cnt_reg[1]_0\ : in STD_LOGIC;
...
architecture STRUCTURE of zsys_axi_i2s_adi_0_0_dma_fifo is
  signal \^i22\ : STD_LOGIC_VECTOR ( 0 to 0 );
...
architecture STRUCTURE of zsys_axi_i2s_adi_0_0_dma_fifo_0 is
  signal \^i29\ : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ram_slice_end of data_fifo_reg_0_7_6_11 : label is 11;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \free_cnt[0]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \free_cnt[1]_i_1\ : label is "soft_lutpair26";
...
architecture STRUCTURE of zsys_axi_i2s_adi_0_0_fifo_synchronizer is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \rd_addr[0]_i_1__0\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \rd_addr[1]_i_1__0\ : label is "soft_lutpair21";
...
architecture STRUCTURE of zsys_axi_i2s_adi_0_0_fifo_synchronizer_1 is
  ...
  attribute ram_slice_end of fifo_reg_0_3_0_4 : label is 4;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \rd_addr[0]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \rd_addr[1]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \wr_addr[0]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \wr_addr[1]_i_1\ : label is "soft_lutpair23";
begin
fifo_reg_0_3_0_4: unisim.vcomponents.RAM32M
     port map (
      ADDRA(4 downto 2) => B"000",
...
\pl330_dma_tx_gen.tx_fifo\: entity work.zsys_axi_i2s_adi_0_0_pl330_dma_fifo
     port map (
      ...
      empty => empty,
      enable_int => \tx_gen.tx/enable_int\,
      \free_cnt_reg[1]\ => axi_i2s_adi_S_AXI_inst_n_7,
...
entity zsys_axi_i2s_adi_0_0 is
  ...
  attribute x_core_info of zsys_axi_i2s_adi_0_0 : entity is "axi_i2s_adi_v1_2,Vivado 2018.3";
...
architecture STRUCTURE of zsys_axi_i2s_adi_0_0 is
  ...
  attribute x_interface_parameter of DMA_REQ_RX_ACLK : signal is "XIL_INTERFACENAME DMA_RX_CLK, ASSOCIATED_BUSIF DMA_RX_REQ:DMA_RX_ACK, ASSOCIATED_RESET DMA_REQ_RX_RSTN, FREQ_HZ 160000000, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1";
  ...
  attribute x_interface_parameter of DMA_REQ_RX_DAVALID : signal is "XIL_INTERFACENAME DMA_RX_ACK, TDATA_NUM_BYTES 0, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 2, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 160000000, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, LAYERED_METADATA undef";
  ...
  attribute x_interface_parameter of DMA_REQ_RX_DRVALID : signal is "XIL_INTERFACENAME DMA_RX_REQ, TDATA_NUM_BYTES 0, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 2, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 160000000, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, LAYERED_METADATA undef";
  ...
  attribute x_interface_parameter of DMA_REQ_TX_ACLK : signal is "XIL_INTERFACENAME DMA_TX_CLK, ASSOCIATED_BUSIF DMA_TX_REQ:DMA_TX_ACK, ASSOCIATED_RESET DMA_REQ_TX_RSTN, FREQ_HZ 160000000, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1";
  ...
  attribute x_interface_parameter of DMA_REQ_TX_DAVALID : signal is "XIL_INTERFACENAME DMA_TX_ACK, TDATA_NUM_BYTES 0, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 2, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 160000000, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, LAYERED_METADATA undef";
  ...
  attribute x_interface_parameter of DMA_REQ_TX_DRVALID : signal is "XIL_INTERFACENAME DMA_TX_REQ, TDATA_NUM_BYTES 0, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 2, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 160000000, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, LAYERED_METADATA undef";
  ...
  attribute x_interface_parameter of s00_axi_aclk : signal is "XIL_INTERFACENAME S00_AXI_CLK, ASSOCIATED_BUSIF S00_AXI, ASSOCIATED_RESET s00_axi_aresetn, FREQ_HZ 160000000, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1";
