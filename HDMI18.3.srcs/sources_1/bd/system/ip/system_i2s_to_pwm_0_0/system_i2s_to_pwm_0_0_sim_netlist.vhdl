...
-- Date        : Mon Feb 10 03:42:51 2025
-- Host        : DESKTOP-0SNREP6 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               e:/141/HDMI18.3/HDMI18.3.srcs/sources_1/bd/system/ip/system_i2s_to_pwm_0_0/system_i2s_to_pwm_0_0_sim_netlist.vhdl
-- Design      : system_i2s_to_pwm_0_0
...
entity system_i2s_to_pwm_0_0_i2s_to_pwm is
  port (
  ...
  attribute ORIG_REF_NAME of system_i2s_to_pwm_0_0_i2s_to_pwm : entity is "i2s_to_pwm";
end system_i2s_to_pwm_0_0_i2s_to_pwm;

architecture STRUCTURE of system_i2s_to_pwm_0_0_i2s_to_pwm is
...
\pwm_s_cnt_reg[4]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 1) => pwm_s_cnt(4 downto 2),
      S(0) => \pwm_s_cnt[4]_i_4_n_0\
    );
\pwm_s_cnt_reg[4]_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => pwm_s_cnt(0),
      DI(3 downto 1) => pwm_s_cnt(4 downto 2),
      DI(0) => '0',
      O(3 downto 0) => \plusOp__0\(4 downto 1),
      S(3) => \pwm_s_cnt[4]_i_5_n_0\,
      S(2) => \pwm_s_cnt[4]_i_6_n_0\,
      S(1) => \pwm_s_cnt[4]_i_7_n_0\,
      S(0) => pwm_s_cnt(1)
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_i2s_to_pwm_0_0 is
  port (
    clk_in : in STD_LOGIC;
    i2s_bclk : in STD_LOGIC;
    i2s_lrclk : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of system_i2s_to_pwm_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of system_i2s_to_pwm_0_0 : entity is "system_i2s_to_pwm_0_0,i2s_to_pwm,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of system_i2s_to_pwm_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of system_i2s_to_pwm_0_0 : entity is "i2s_to_pwm,Vivado 2018.3";
end system_i2s_to_pwm_0_0;

architecture STRUCTURE of system_i2s_to_pwm_0_0 is
  attribute x_interface_info : string;
  attribute x_interface_info of clk_in : signal is "xilinx.com:signal:clock:1.0 clk_in CLK";
  attribute x_interface_parameter : string;
  attribute x_interface_parameter of clk_in : signal is "XIL_INTERFACENAME clk_in, PHASE 0.000, CLK_DOMAIN system_processing_system7_0_0_FCLK_CLK1, INSERT_VIP 0";
begin
U0: entity work.system_i2s_to_pwm_0_0_i2s_to_pwm
     port map (
      clk_in => clk_in,
      i2s_bclk => i2s_bclk,
      i2s_lrclk => i2s_lrclk,
